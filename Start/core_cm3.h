...
/** @addtogroup CMSIS_CM3_DWT CMSIS CM3 DWT
  memory mapped structure for Data Watchpoint and Trace (DWT)
  @{
 */
typedef struct
{
  __IO uint32_t CTRL;                         /*!< Offset: 0x00  Control Register */
  __IO uint32_t CYCCNT;                       /*!< Offset: 0x04  Cycle Count Register */
  __IO uint32_t CPICNT;                       /*!< Offset: 0x08  CPI Count Register */
  __IO uint32_t EXCCNT;                       /*!< Offset: 0x0C  Exception Overhead Count Register */
  __IO uint32_t SLEEPCNT;                     /*!< Offset: 0x10  Sleep Count Register */
  __IO uint32_t LSUCNT;                       /*!< Offset: 0x14  LSU Count Register */
  __IO uint32_t FOLDCNT;                      /*!< Offset: 0x18  Folded-instruction Count Register */
  __IO uint32_t PCSR;                         /*!< Offset: 0x1C  Program Counter Sample Register */
  __IO uint32_t COMP0;                        /*!< Offset: 0x20  Comparator Register 0 */
  __IO uint32_t MASK0;                        /*!< Offset: 0x24  Mask Register 0 */
  __IO uint32_t FUNCTION0;                    /*!< Offset: 0x28  Function Register 0 */
    uint32_t RESERVED0[1];
  __IO uint32_t COMP1;                        /*!< Offset: 0x30  Comparator Register 1 */
  __IO uint32_t MASK1;                        /*!< Offset: 0x34  Mask Register 1 */
  __IO uint32_t FUNCTION1;                    /*!< Offset: 0x38  Function Register 1 */
    uint32_t RESERVED1[1];
  __IO uint32_t COMP2;                        /*!< Offset: 0x40  Comparator Register 2 */
  __IO uint32_t MASK2;                        /*!< Offset: 0x44  Mask Register 2 */
  __IO uint32_t FUNCTION2;                    /*!< Offset: 0x48  Function Register 2 */
    uint32_t RESERVED2[1];
  __IO uint32_t COMP3;                        /*!< Offset: 0x50  Comparator Register 3 */
  __IO uint32_t MASK3;                        /*!< Offset: 0x54  Mask Register 3 */
  __IO uint32_t FUNCTION3;                    /*!< Offset: 0x58  Function Register 3 */
} DWT_Type;

/* DWT Control Register Definitions */
#define DWT_CTRL_CYCCNTENA_Pos               0                                             /*!< DWT CTRL: CYCCNTENA Position */
#define DWT_CTRL_CYCCNTENA_Msk              (1ul << DWT_CTRL_CYCCNTENA_Pos)               /*!< DWT CTRL: CYCCNTENA Mask */
/*@}*/ /* end of group CMSIS_CM3_DWT */
